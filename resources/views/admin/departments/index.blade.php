            ...
            <div class="card">
                <h5>
                    <div class="card-header text-center">
                        {{ __('Department Records') }}
                        <div class="btn-group float-right">
                            <a href="{{ route('admin.departments.create') }}" class="btn btn-lg"><i
                    ...
                    <table class="table table-striped dTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Stablished Date</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm float-right">
                                        ...
                                        <form action="{{ route('admin.departments.destroy', $item) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
