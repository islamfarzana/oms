            ...
            <div class="card alert-light">
                <div class="card-header text-center bg-secondary text-light font-weight-bold text-uppercase">Edit role
                    <span class="float-right">
                        <a href="{{ route('admin.roles.index') }}" class="btn btn-sm"><i
                                class="text-light fas fa-arrow-left"></i></a>
                    </span>
                </div>
                <div class="card-body">
                    <form class="form-prevent" action="{{ route('admin.roles.update', $roles->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 offset-2">
                                <input id="name" type="text" value="{{ $roles->name }}" placeholder="Name"
