    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card alert-light">
                ...
                <div class="card-body">
                    <form class="form-prevent" method="POST" action="{{ route('admin.employees.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 offset-2">
                                <input id="enrolment_date" type="date" placeholder="Enrolment Date"
                                    ...
                                    name="enrolment_date" value="" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8 offset-2">
                                <select class="form-control @error('designation_id') is-invalid @enderror"
                                    ...
                                    <option value="" style="display: none;" disabled selected>Select designation
                                    </option>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-8 offset-2 mx-auto">
                                <button type="submit" class="btn btn-secondary w-100 button-prevent">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
